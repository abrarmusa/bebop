    ...
    this.each( function()
    {
      ...
      if( isSupport )
      {
        ...
        var theBar        = thePlayer.find( '.' + cssClass.bar ),
          ...
          volumeAdjuster    = $('.min-slider-handle'),
          volumeDefault   = 0,
          ...
          adjustVolume = function( e )
          {
            ...
            var currentVol = parseInt($("#ex1").val(), 10);
            theAudio.volume = currentVol/10;
        ...
        theAudio.addEventListener( 'loadeddata', function()
        {
          ...
          $('.slider-selection' ).width( theAudio.volume * 100 + '%' );
          $('.min-slider-handle' ).css( "left", theAudio.volume * 100 + '%' );
        ...
        $('.min-slider-handle').on( eStart, function( e )
        {
          console.log(e);
          adjustVolume( e );
